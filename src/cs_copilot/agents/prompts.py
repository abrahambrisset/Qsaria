...
QSAR_TRAINING_INSTRUCTIONS = [
    ...
    '  - For unqualified training requests such as `entraine un modele Chemprop pour pEC50` or `train a Chemprop model for pEC50`, use `request.validation={"kind":"standard_qsar"}`.',
