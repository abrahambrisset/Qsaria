...
QSAR_TRAINING_INSTRUCTIONS = [
    ...
    "  - When the user explicitly asks for a tabular molecular representation, call `train_lightgbm_model`, `train_tabicl_model`, or `train_qsar_model` with `representation_name`; these facades prepare Morgan/RDKit features and caches internally.",
