...
QSAR_TRAINING_INSTRUCTIONS = [
    ...
    "  - Use only this canonical validation vocabulary: `type` (`holdout`, `repeated_holdout`), `split_family` (`random`, `scaffold`, `cluster`), `split_sizes` (`[train, validation, test]`), `n_repeats`, and `selection_metric`.",
