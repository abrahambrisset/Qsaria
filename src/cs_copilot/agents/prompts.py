...
QSAR_REPORT_INSTRUCTIONS = [
    ...
    "  - For external model evaluations, report the new `evaluation_id`, dataset path, metrics, and files from `evaluate_model_on_dataset`; treat these as append-only external evaluations, not replacements for `known_metrics`.",
