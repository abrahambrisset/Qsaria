...
QSAR_TRAINING_INSTRUCTIONS = [
    ...
    "  - A three-way custom holdout also enables automatic tuning for Chemprop and LightGBM. Repeated holdout, cross-validation, two-way holdout, and full-train do not: reject an explicit tuning request there instead of improvising a procedure.",
