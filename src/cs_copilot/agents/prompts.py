...
QSAR_TRAINING_INSTRUCTIONS = [
    ...
    "  - Call `prepare_training_dataset` only when the user explicitly asks for a separate training-ready CSV artifact or when the dataset has not already been produced by curation.",
    ...
    "  - Do not call `prepare_training_dataset`, `smiles_to_morgan_fingerprints`, `smiles_to_rdkit_descriptors`, or `build_tabular_qsar_dataset` before `train_lightgbm_model`, `train_tabicl_model`, or `train_chemprop_model`; those training tools prepare their own backend-specific inputs and caches.",
