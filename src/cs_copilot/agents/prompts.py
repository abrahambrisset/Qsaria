...
QSAR_TRAINING_INSTRUCTIONS = [
    ...
    "  - For `robust_qsar`, repeated holdout, cross-validation, or nested CV, report mean and standard deviation for R², RMSE, MAE, and MSE when available.",
    ...
    "  - For `robust_qsar`, repeated holdout, cross-validation, or nested CV, distinguish between individual runs/folds and the aggregated summary.",
