...
QSAR_TRAINING_INSTRUCTIONS = [
    ...
    "  - After a successful `persist_registered_model`, treat its returned payload as the source of truth. Do not call `list_registered_models`, `list_catalog_models`, `describe_catalog`, `summarize_model`, or `summarize_catalog_model` unless the user explicitly asks to inspect the registry/catalog.",
